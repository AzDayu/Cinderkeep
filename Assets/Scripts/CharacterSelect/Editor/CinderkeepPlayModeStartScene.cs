...
{
    [InitializeOnLoad]
    public static class CinderkeepPlayModeStartScene
    {
        private const string StartScenePath = "Assets/Scenes/Main_Lobby.unity";

        static CinderkeepPlayModeStartScene()
        {
        ...
        private static void OpenStartSceneIfNeeded()
        {
            ...
            {
                Debug.Log("CinderkeepPlayModeStartScene: Main_Lobby was not auto-opened because the current scene has unsaved changes.");
                return;
            }
